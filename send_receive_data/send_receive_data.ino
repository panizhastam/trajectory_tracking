...
void parseData() {
  ...
  elbow_pos_control = atof(strtokIndx);
  
  strtokIndx = strtok(NULL, ","); // this continues where the previous call left off
  shfe_pos_control = atof(strtokIndx);     // convert this part to an integer
  
  strtokIndx = strtok(NULL, ","); 
  shaa_pos_control = atof(strtokIndx);     // convert this part to a float
...
void ShAAcontrol(){
  ...
  double f = 0.0;
  if (shaa_pos_control > -0.1 && shaa_pos_control < 1.5){
    pos_d = shaa_pos_control;
  }
